  ...
  function getmovie() {
    ...
    document.getElementById('poster').style.backgroundColor = "black";
    ...
    var movies = JSON.parse(reqhttp.responseText);
      ...
      function ProcessMovie() {
        if (reqMovie.readyState == 4 && reqMovie.status == 200) {
          ...
          document.getElementById('poster').style.backgroundImage = "url('" + "https://image.tmdb.org/t/p/original" + movie.results[0].backdrop_path; +"')";
